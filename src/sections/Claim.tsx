...
const floatImages: FloatImage[] = [
  ...
  {
    id: 'f12',
    src: '/src/assets/images/Pin on Showww.jpg',
    width: 125,
    top: '52%',
    left: '48%',
    depth: -10,
    ...
    const ctx = gsap.context(() => {
      ...
      gsap.utils.toArray<HTMLElement>('.claim__img').forEach((img) => {
        ...
        gsap.fromTo(
          ...
          { y: depth },
          {
            y: depth * 3, // increase multiplier to amplify parallax strength
            ease: 'none',
            scrollTrigger: {
              trigger: sectionRef.current,
              start: 'top bottom',
        ...
        img.addEventListener('mousemove', (e) => {
          ...
          gsap.to(img, { rotateX: relY, rotateY: relX, duration: 0.4, ease: 'power2.out' })
        })
    ...
    <section className="claim" id="claim" ref={sectionRef}>
      <div className="claim__stage">
        ...
        <div className="claim__headline">
          <h2>From concept to spectacle, we craft bold visual worlds for galleries, brands, and
            cultural spaces.</h2>
          <p className="claim__subhead">
            Immersive projections and art installations that move Berlin.
          </p>
        </div>
      </div>
    </section>
