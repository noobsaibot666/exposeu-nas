...
const configs: Record<'en' | 'de', AdLandingPageConfig> = {
  en: {
    ...baseConfig,
    title: 'Concert Photo and Video Content Berlin',
    description: 'Concert photo and video content in Berlin for artists, venues, promoters, and teams who need fast social, press, and recap assets.',
    h1Line1: 'Concert photo and video content',
    h1Line2: 'for your next show.',
    subheadline: 'For artists, venues, promoters, and music teams who need stage photos, crowd energy, short clips, and fast selects after the night.',
  ...
  de: {
    ...baseConfig,
    title: 'Konzert Foto- und Videocontent Berlin',
    description: 'Foto- und Videocontent für Konzerte und Live-Events in Berlin, für Artists, Venues, Promoter und Teams, die schnelle Social-, Presse- und Recap-Assets brauchen.',
    h1Line1: 'Konzert Foto- und Videocontent',
    h1Line2: 'für deine nächste Show.',
    subheadline: 'Für Artists, Venues, Promoter und Musikteams, die Bühnenfotos, Crowd-Energie, kurze Clips und schnelle Selects nach der Nacht brauchen.',
