...
const configs: Record<'en' | 'de', AdLandingPageConfig> = {
  en: {
    ...
    audienceBody: ['Pop-ups move fast. The setup, the people, the food, the products, the energy of the room — everything happens in a short window. We document it while it\'s alive.'],
    audienceGroups: [
      {
        title: 'For',
    ...
    includedCards: [
      { slug: 'space-photos', title: 'Space photos', body: 'Clean views of the setup, layout, design, and finish.' },
    ...
    proofItems: [
      ...
      { title: 'More than documentation', body: 'We document the space, the product, the people and the small moments that make the experience worth sharing — material you can use long after the doors close.' },
    ],
    ...
    platforms: [
      ...
      { name: 'Website', use: 'Clean proof of the space, product, audience and energy of the day.' },
  ...
  de: {
    ...
    audienceBody: ['Pop-ups bewegen sich schnell. Setup, Menschen, Food, Produkte, Energie des Raums — alles passiert in einem kurzen Zeitfenster. Wir dokumentieren es, solange es lebt.'],
    audienceGroups: [
      {
        title: 'Für',
    ...
    includedCards: [
      { slug: 'space-photos', title: 'Space-Fotos', body: 'Klare Views von Setup, Layout, Design und Umsetzung.' },
    ...
    proofItems: [
      ...
      { title: 'Mehr als Dokumentation', body: 'Wir dokumentieren den Space, das Produkt, die Menschen und die kleinen Momente, die die Experience teilenswert machen — Material, das noch lange nach dem Abschluss nutzbar ist.' },
    ],
    ...
    platforms: [
      ...
      { name: 'Website', use: 'Klarer Proof von Space, Produkt, Publikum und Energie des Tages.' },
