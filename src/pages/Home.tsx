...
const heroGallery = [
  {
    id: 'thumb-1',
    image: resolveImagePath('/src/assets/images/services/1_exhibition_doc/1_ED_034.png'),
    label: 'Exhibitions',
    rotation: -3,
  },
  {
    id: 'thumb-2',
    image: resolveImagePath('/src/assets/images/services/3_artist_sessions/3_AS_014.png'),
    label: 'Artist sessions',
    rotation: 2,
  },
  {
    id: 'thumb-3',
    image: resolveImagePath('/src/assets/images/services/2_gallery_work/2_GW_017.png'),
    label: 'Documentations',
    rotation: -1,
  },
  {
    id: 'thumb-4',
    image: resolveImagePath('/src/assets/images/services/4_performance_doc/4_PD_002.png'),
    label: 'Performances',
    rotation: 4,
  },
  {
    id: 'thumb-5',
    image: resolveImagePath('/src/assets/images/services/5_fashion_show/5_FS_006.jpeg'),
    label: 'Fashion shows',
    rotation: -4,
  },
]
