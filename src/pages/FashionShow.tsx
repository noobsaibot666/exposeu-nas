...
function FashionShow() {
  return (
    <WorkPageLayout
      ...
      gallery={[
        { title: 'Runway clarity', subtitle: 'Clean coverage of each look for designers and PR.' },
      ...
      extraGalleryCopy="Editorial coverage and fast delivery so your collection hits every channel on time."
      extraGallery={[
      ...
      extraGallerySecondary={[
        ...
        { title: 'Pit and roaming', subtitle: 'Primary angle and roaming coverage for varied perspectives.' },
      ...
      ctaText="Book fashion show coverage. Share your date, venue, and show timing."
      ctaHref="/contact"
    />
  )
}
